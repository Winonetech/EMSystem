...
[Files]
Source: "MapViewerAIR\Adobe AIR\*"; DestDir: "{app}\Adobe AIR"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "MapViewerAIR\META-INF\*"; DestDir: "{app}\META-INF"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "MapViewerAIR\mimetype"; DestDir: "{app}"; Flags: ignoreversion
Source: "MapViewerAIR\MapViewerAIR.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "MapViewerAIR\MapViewerAIR.swf"; DestDir: "{app}"; Flags: ignoreversion
