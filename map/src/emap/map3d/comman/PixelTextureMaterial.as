...
package emap.map3d.comman
{
	 ...
	 */
	public class PixelTextureMaterial extends Material {
		 ...
		 */
		public function PixelTextureMaterial(diffuseMap:TextureResource = null, opacityMap:TextureResource = null, alpha:Number = 1, smoothing:Boolean = false) {
		...
		private function getProgram(object:Object3D, programs:Vector.<ShaderProgram>, camera:Camera3D, opacityMap:TextureResource, alphaTest:int):ShaderProgram {
			...
			if (program == null) {
				...
				if(opacityMap != null) {
					outProcedure = getDiffuseOpacityProcedure;
					if(this.smoothing) {
						outProcedure.compileFromArray([
							"#v0=vUV",
							"#s0=sDiffuse",
							"#s1=sOpacity",
							"#c0=cThresholdAlpha",
							"tex t0, v0, s0 <2d,nearest,clip,mipnone>",
							"tex t1, v0, s1 <2d,nearest,clip,mipnone>",
							"mul t0.w, t1.x, c0.w",
							"mov o0, t0"
						]);
					}
				} else {
					outProcedure = getDiffuseProcedure;
					if(this.smoothing) {
						outProcedure.compileFromArray([
							"#v0=vUV",
							"#s0=sDiffuse",
		...
		override public function clone():Material {
			var res:PixelTextureMaterial = new PixelTextureMaterial(diffuseMap, opacityMap, alpha);
		...
		override protected function clonePropertiesFrom(source:Material):void {
			...
			var tex:PixelTextureMaterial = source as PixelTextureMaterial;
